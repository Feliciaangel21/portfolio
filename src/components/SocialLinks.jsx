...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://linkedin.com/in/felicia-angel-1b0a46254/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@FANGEL.21",
    icon: Instagram,
    url: "https://www.instagram.com/FANGEL.21/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@feliciaangel",
    icon: Github,
    url: "https://github.com/feliciaangel21",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  const others = socialLinks.filter((link) => link.name !== "LinkedIn");
