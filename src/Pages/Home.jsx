...
const WORDS = [ "Analytics Professional", "Machine Learning Specialist", "Business Intelligence Analyst", "Predictive Analytics Expert"];
const TECH_STACK = ["Python", "SQL", "Pandas", "NumPy", "Tableau", "Excel"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Feliciaangel21" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/felicia-angel-1b0a46254/" },
  { icon: Instagram, link: "https://www.instagram.com/fangel.21/?hl=en" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Delivering insightful, actionable, and user-friendly data solutions.
                </p>
